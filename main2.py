...
while True:
    ...
    #4.Delete Student
        ...
        if del_name in student:
            ...
            with open("students.txt","w") as file:
                for student_name,student_marks in student.items():
    ...
    # 5. Update student marks
        ...
        update_name = input("Enter the name pf the student to update marks: ")
        if update_name in student:
            try:
                ...
                with open("students.txt","w") as file:
                    for student_name,student_marks in student.items():
                        file.write(f"{student_name},{student_marks}\n")
                print(f"{update_name}'s marks updated successfully!")
            except ValueError:
                print(" Invalid marks input! ")
        else:
            print("Student not found!")
